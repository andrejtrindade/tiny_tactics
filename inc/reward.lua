...
gray_text = split("4;by earning trophies for all;0 ; 5;levels, you have unlocked...;0 ; 9;you can now play as...;0 ;"..
	"13;to change the current skin, ;0 ; 14;select;0 ; 14;on the;15 ; 15;...;12", ";"),

white_text = split("2,congratulations!,0 , 7,an alternative skin!,0 , 11,'s boss!,9 , 15,title screen,0"),

blue_text = split("11,agent 101,0 , 14,options,7")
